    ...
    public partial class database : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.type_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    doanhthu_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    numberofsales = table.Column<int>(type: "int", nullable: false),
                    tongdoanhthu = table.Column<decimal>(type: "decimal(18,0)", precision: 18, scale: 0, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TotalRevenues", x => x.doanhthu_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    type_id = table.Column<int>(type: "int", nullable: false),
                    Desdescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Product_Advertisement_advertisement_id",
                        column: x => x.advertisement_id,
                        principalTable: "Advertisement",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Product_Categories_type_id",
                        column: x => x.type_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Oders", x => x.bill_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cata_Product", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    quantity = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,0)", precision: 18, scale: 0, nullable: false),
                    Cata_product = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Size = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_Oders_bill_id",
                        column: x => x.bill_id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    variants_product_id = table.Column<int>(type: "int", nullable: false),
                    quantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Size_Product", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Size_Product_Cata_Product_variants_product_id",
                        column: x => x.variants_product_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_advertisement_id",
                table: "Product",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Size_Product_variants_product_id",
                table: "Size_Product",
